...
import "../../contracts/soulhub/ISoulhub.sol";
import "./ISoulboundUpgradeable.sol";

library SoulboundUpgradeableErrorCodes {
    string constant InvalidInterface = "SoulboundUpgradeable:InvalidInterface";
    string constant InvalidAddress = "SoulboundUpgradeable:InvalidAddress";
    string constant NotOwnerOrSoulhubAdministrator =
        "SoulboundUpgradeable:NotOwnerOrSoulhubAdministrator";
}
 ...
 * found in sbt/ERC721SoulboundUpgradeable: soulhub administrators can sign a message hash, to authorize the user to perform the mint function. Or a more complex business case
 ...
 */
contract SoulboundUpgradeable is
    Initializable,
    OwnableUpgradeable,
    ERC165Upgradeable,
    ISoulboundUpgradeable
{
     ...
     */
    function initialize(address soulhub_)
        public
    ...
    modifier onlyOwnerOrSoulhubAdministrator() {
        require(
            ...
            SoulboundUpgradeableErrorCodes.NotOwnerOrSoulhubAdministrator
        );
        _;
    }
    ...
    modifier interfaceGuard(address account_, bytes4 interfaceId_) {
        ...
        require(
            ...
            SoulboundUpgradeableErrorCodes.InvalidInterface
        );
        _;
    }
     ...
     */
    function _checkOwnerOrSoulhubAdministrator(address account_)
        internal
        view
        returns (bool)
    {
     ...
     */
    function _checkSoulhubAdministrator(address account_)
        internal
        view
        returns (bool)
    {
     ...
     */
    function _checkSameSoul(address targetAccount_, address account_)
        internal
        view
        returns (bool)
    {
     ...
     */
    function subscribeSoulhub(address soulhub_)
        external
        onlyOwner
        interfaceGuard(soulhub_, type(ISoulhub).interfaceId)
    {
    ...
    {
        return
            interfaceId_ == type(ISoulboundUpgradeable).interfaceId ||
